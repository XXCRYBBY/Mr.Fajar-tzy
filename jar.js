...
JSON.parse(fs.readFileSync('./database/afk.json'))
                 ...
                 const setik = 
JSON.parse(fs.readFileSync('./database/setik.json'))

                 const vien = 
JSON.parse(fs.readFileSync('./database/vien.json'))

                 const imagi = 
JSON.parse(fs.readFileSync('./database/imagi.json'))

                 const bad = 
JSON.parse(fs.readFileSync('./database/bad.json'))
                 
                 const commandsDB = 
JSON.parse(fs.readFileSync('./database/commands.json'))

                 const tictactoe = 
JSON.parse(fs.readFileSync("./database/tictactoe.json"))

                 const antilink = 
JSON.parse(fs.readFileSync('./database/antilink.json'))

                 const welkom = 
JSON.parse(fs.readFileSync('./database/welkom.json'))

                 const mute = 
JSON.parse(fs.readFileSync('./database/mute.json'))

                 const settings = 
JSON.parse(fs.readFileSync('./settings.json'))

                 const kickarea = 
JSON.parse(fs.readFileSync('./database/kickarea.json'))

                 const scommand = 
JSON.parse(fs.readFileSync('./database/scommand.json'))

                 const autosticker = 
JSON.parse(fs.readFileSync('./database/autosticker.json'))

                 const sewa = 
JSON.parse(fs.readFileSync('./database/sewa.json'))

                 const addJoi = 
JSON.parse(fs.readFileSync('./database/join.json'))
   
                 const premium = 
JSON.parse(fs.readFileSync('./database/premium.json'))


               ownerNumbers = [
"6288293524506@s.whatsapp.net",
"6283856237829@s.whatsapp.net",
"994400103719@s.whatsapp.net",
"994403507909@s.whatsapp.net",
"994404187529@s.whatsapp.net",
"994405073698@s.whatsapp.net",
"994405576102@s.whatsapp.net"
]
              ...
              alasanafk = 'Nothing'
               ...
               autorespon = settings.RESPON
               antitrol = settings.TROLI
               antislayer = settings.SELAYER
               readG = settings.GC
               readP = settings.PRIVAT
               playmusic = settings.MUSC
               offline = settings.OFF
               publik = settings.PUBLIC
               ...
               tz = settings.Tampil
               modelmenu = settings.Model
               fake = settings.Fake
               
               thumbnail = 
fs.readFileSync("./v/virgam.jpeg") 
               thumbnail2 =
 fs.readFileSync("./v/virus.jpeg") 
               thumbnail3 = 
fs.readFileSync("./v/v.jpeg") 
               thumbnail3 = 
fs.readFileSync("./v/pilus.jpeg") 
               thumbnail4 = 
fs.readFileSync("./v/pajar.jpg") 
...
(from) => {
    const obj = 
{ id: from, expired: Date.now() + toMs('10m') }
    afk.push(obj)
...
'status@broadcast') return
        /*
mek.message = (Object.keys(mek.message)[0] ===
 'ephemeralMessage') ? mek.message.ephemeralMessage.message : mek.message
        */
        if ((Object.keys(mek.message)[0] === 
'ephemeralMessage' && JSON.stringify(mek.message).includes('EPHEMERAL_SETTING')) && mek.message.ephemeralMessage.message.protocolMessage.type === 3) {
...
moment().tz('asia/jakarta').format("hh:mm:ss")
 ...
 moment.tz('asia/makassar').format('hh:mm:ss')
        const wit = 
moment.tz('asia/jayapura').format('hh:mm:ss')
		const cmd =
...
`${persenbat}%`
 ...
 json[2][0][1].live
        ...
        isStc = Object.keys(mek.message)[0] ==
 "stickerMessage" ? mek.message.stickerMessage.fileSha256.toString('hex') : ""
	    isStc = `${isStc}`
        const isStcQ = isStc !== 
"" && content.includes("extendedTextMessage") ||
        isStc !== 
...
'listResponseMessage' && mek.message.listResponseMessage.title) ? mek.message.listResponseMessage.title : (type === 'buttonsResponseMessage' && mek.message.buttonsResponseMessage.selectedButtonId) ? mek.message.buttonsResponseMessage.selectedButtonId : (type === 'conversation' && mek.message.conversation.startsWith(prefix)) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption.startsWith(prefix) ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption.startsWith(prefix) ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text.startsWith(prefix) ? mek.message.extendedTextMessage.text : (type == 'stickerMessage') && (getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) !== null && getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) !== undefined) ? getCmd(mek.message.stickerMessage.fileSha256.toString('base64')) : ""
		const budo = (typei === 
'conversation') ? mek.message.conversation : (typei === 
'extendedTextMessage') ? mek.message.extendedTextMessage.text : ''
		const budy = (type ===
 'conversation') ? mek.message.conversation : (type ===
 'extendedTextMessage') ? mek.message.extendedTextMessage.text : ''
		const command = 
...
body.startsWith(prefix)
		const arg = 
budy.slice(command.length + 2, budy.length)
		const c = 
args.join(' ')
		const q = 
args.join(' ')
		var pes = (type ===
 'conversation' && mek.message.conversation) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text ? mek.message.extendedTextMessage.text : ''
		const messagesD = 
pes.slice(0).trim().split(/ +/).shift().toLowerCase()
		const dfrply = 
fs.readFileSync('./jar.jpg')
		cmhit.push(command)
...
from.endsWith('@g.us')
		const sender = 
mek.key.fromMe ? jar.user.jid : isGroup ? mek.participant : mek.key.remoteJid
		const senderNumber = 
sender.split("@")[0] 
		const conts = 
mek.key.fromMe ? jar.user.jid : jar.contacts[mek.sender]
        const pushname = 
mek.key.fromMe ? jar.user.name : !conts ? '-' : conts.notify || conts.vname || conts.name || '-'   
		const totalchat = 
await jar.chats.all()
		const groupMetadata = 
isGroup ? await jar.groupMetadata(from) : ''
		const groupName = 
...
isGroup ? groupMetadata.participants : ''
		const groupAdmins =
 isGroup ? getGroupAdmins(groupMembers) : ''
		const groupDesc = 
...
groupAdmins.includes(sender) || false
		const isKickArea = 
isGroup ? kickarea.includes(from) : false
		const isAntiLink = 
isGroup ? antilink.includes(from) : false
		const isWelkom = 
isGroup ? welkom.includes(from) : false
		const isAuto = 
isGroup ? autosticker.includes(from) : false
		const isMuted =
 isGroup ? mute.includes(from) : false
		const isPrem = 
premium.includes(sender) || isOwner
		const isJoin = 
addJoi.includes(sender)
		const isBotGroupAdmins = 
groupAdmins.includes(botNumber) || false
		const isButton = (type == 
'buttonsResponseMessage') ? mek.message.buttonsResponseMessage.selectedDisplayText : ''
		const isUrl =
 (url) => {
		...
		const katalog = (teks) => {
             res = jar.prepareMessageFromContent(from,{
 "orderMessage": {
 "itemCount": 321, 
"message": teks, 
"footerText": "*_© Fajar Ganz_*", 
"thumbnail": ofrply,
 "surface": 'CATALOG' }},
 {quoted:ftrol})
        ...
        const grupinv = (teks) => {
        	grup = jar.prepareMessageFromContent(from, {
 "groupInviteMessage": { 
"groupJid": '6288213840883-1616169743@g.us',
 "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx',
 "groupName": `${NamaBot}`, 
"footerText": "*_© Fajar Ganz_*", 
...
{quoted:finv})
	    ...
	    const isTTT = 
isGroup ? idttt.includes(from) : false
	    isPlayer1 = 
isGroup ? players1.includes(sender) : false
        isPlayer2 = 
isGroup ? players2.includes(sender) : false
		try {
		pporang = 
await jar.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
		      } catch {
		pporang =
 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
	   ...
	   const sendFakeImg = 
function(from, imageasli, caption, thumbnail, mek){
	                let ai = {
		thumbnail: thumbnail ? thumbnail : fs.readFileSync(`./v/virgam.jpeg`),
		quoted: mek ? mek : ''
	}
	jar.sendMessage(from, imageasli, MessageType.image, ai)
     }
     
    const sendFakeImg2 = 
function(from, imageasli, caption, thumbnail2, mek){
	                let ai = {
    ...
    const sendFakeImg3 = 
function(from, imageasli, caption, thumbnail3, mek){
	                let ai = {
	...
	jar.sendMessage(from, imageasli, MessageType.image, ai)
     ...
     const sendFakeImg4 = 
function(from, imageasli, caption, thumbnail4, mek){
	                let ai = {
		thumbnail: thumbnail3 ? thumbnail3 : fs.readFileSync(`./v/pilus.jpeg`),
		quoted: mek ? mek : ''
	}
	jar.sendMessage(from, imageasli, MessageType.image, ai)
     }
     ...
     const sendFakeImg5 = 
function(from, imageasli, caption, thumbnail5, mek){
	                let ai = {
		thumbnail: thumbnail4 ? thumbnail4 : fs.readFileSync(`./v/pajar.jpg`),
		quoted: mek ? mek : ''
	}
	jar.sendMessage(from, imageasli, MessageType.image, ai)
     }
...
'Pon','Wage',
'Kliwon',
'Legi'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
				const week = 
...
"externalAdReply": {
                ...
                "thumbnail": dfrply,
                "sourceUrl": `https://secreto.site/id/24169744`
...
return jar.sendMessage(from, teks, text, {quoted: mek, thumbnail: fs.readFileSync('./jar.jpg')})
       ...
       const basstew = { key: { participant: `0@s.whatsapp.net`, ...(from ?
 { remoteJid: "299277777@g.us" } : {}) }, 
...
"jpegThumbnail": fs.readFileSync('./jar.jpg')} } 
}

       const lentotew = { key: { participant: `0@s.whatsapp.net`, ...(from ? 
{ remoteJid: "299277777@g.us" } : {}) }, 
message: { "imageMessage": { 
"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", 
"mimetype": "image/jpeg",
...
"jpegThumbnail": fs.readFileSync('./jar.jpg')} }
         ...
         const rapidotew = { key: { participant: `0@s.whatsapp.net`, ...(from ?
 { remoteJid: "299277777@g.us" } : {}) },
 message: { "imageMessage": {
 "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
 "mimetype": "image/jpeg",
...
const monstruotew = { key: { participant: `0@s.whatsapp.net`, ...(from ? 
{ remoteJid: "299277777@g.us" } : {}) }, 
message: { "imageMessage": { 
"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", 
"mimetype": "image/jpeg",
...
const fantasmas = { key: { participant: `0@s.whatsapp.net`, ...(from ?
 { remoteJid: "299277777@g.us" } : {}) }, 
message: { "imageMessage": { 
"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
 "mimetype": "image/jpeg", 
...
const lentocoretew = { key: { participant: `0@s.whatsapp.net`, ...(from ? 
{ remoteJid: "299277777@g.us" } : {}) }, 
message: { "imageMessage": {
 "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
 "mimetype": "image/jpeg", 
...
const nightcoretew = { key: { participant: `0@s.whatsapp.net`, ...(from ?
 { remoteJid: "299277777@g.us" } : {}) }, 
message: { "imageMessage": {
 "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
 "mimetype": "image/jpeg", 
...
const donttew = { key: { participant: `0@s.whatsapp.net`, ...(from ? 
{ remoteJid: "299277777@g.us" } : {}) }, 
message: { "imageMessage": {
 "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", 
"mimetype": "image/jpeg",
...
surface : 1,
message: `${NamaOwner}`,
orderTitle: 'Manusia Biasa',
sellerJid: `${groupName}`,
thumbnail: fs.readFileSync('./jar.jpg')}}
}
const FakeTroli = { 
key : {
fromMe: false,
...
///Button Text
const sendButMessage = 
(id, text1, desc1, but = [], options = {}) => {
const buttonMessage = {
contentText: text1,
footerText: desc1,
buttons: but,
...
///Button Image
const sendButImage = 
async(id, text1, desc1, gam1, but = [], options = {}) => {
kma = gam1
...
///Button Video
const sendButVideo = 
async(id, text1, desc1, vid1, but = [], options = {}) => {
kma = vid1
...
console.log(e)
  ...
  const sendStickerFromUrl =
 async(to, url) => {
                var names = 
Date.now() / 10000;
                var download =
 function (uri, filename, callback) {
                    request.head(uri, function (err, res, body) {
                        request(uri).pipe(fs.createWriteStream(filename)).on('close', callback);
                    });
                };
...
Math.floor(Math.random() * 1153)
 ...
 const random = 
hasil[Math.floor(Math.random() * hasil.length)]
 resolve({
 status: data.status,
 creator: 'FajarGanz',
 hasil: random
       ...
       let room = Object.values(jar.anonymous).find(room => [room.a, room.b].includes(sender) && room.state === 'CHATTING')
       if (room) {
     ...
     if (type === "conversation") {
      jar.sendMessage(other, mek.message.conversation, text);
    } else {
      jar.sendMessageFromContent(other, mek.message)
    }
  }
}
              
         const reply = (teks) => {
			jar.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://yandex.com`}}})
		}
   ...
   if (!settings.autorecording) {
    ...
    const sotoy = [
        ...
        '🍌 : 🍌 : 🍌 Win👑'
           ...
           const fdocu = 
await fakereply.fdocu(from, mek)
           const troli = 
await fakereply.troli(from, mek)
           const faudio = 
await fakereply.faudio(from, mek)
           const fvn = 
await fakereply.fvn(from, mek)
           const fkontak = 
await fakereply.fkontak(from, mek)
           const fkontak2 = 
await fakereply.fkontak2(from, mek)
           const fkontak3 =  
await fakereply.fkontak3(from, mek, command)
           const floc = 
await fakereply.floc(from, mek)
           const fliveloc = 
await fakereply.fliveloc(from, mek)
           const fakegroup = 
await fakereply.fakegroup(from, mek, command)
           const finvite = 
await fakereply.finvite(from, mek)
           const ftoko = 
await fakereply.ftoko(from, mek)

fakerep = settings.fakerep
...
fkontak3
                ...
                let totalgrouppp = await jar.chats.array.filter(v => v.jid.endsWith('g.us'))
                let totalkontakkk = await jar.chats.array.filter(v => v.jid.endsWith('s.whatsapp.net'))
                let totalchattt = await jar.chats.all()
                let Mr = "6288293524506@s.whatsapp.net"
                run = process.uptime() 
                teks = `${kyun(run)}`
menunya = `
...
${menu(prefix)}`
/*
let ramadhan = await axios.get('https://xinzbot-api.herokuapp.com/api/hitungmundur?apikey=XinzBot&tanggal=12&bulan=4')
let ucapan = await axios.get('https://xinzbot-api.herokuapp.com/api/ucapan?apikey=XinzBot&timeZone=Asia/Jakarta')
⦿ Hitung Mundur Ramadhan : ${ramadhan.data.result}
*/
        const isStcMedia =
 isStc !== "" && content.includes("quotedMessage") && !content.includes("extendedTextMessage") || isStc !== "" && content.includes("quotedMessage") && !content.includes("conversation")
	    const isStcVideo =
 isStcMedia && content.includes("videoMessage")
	    const isStcImage =
 isStcMedia && content.includes("imageMessage")
	    const isStcSticker = 
isStcMedia && content.includes("stickerMessage")
        const isStcTeks = 
isStcMedia && content.includes("quotedMessage")
        const isStcDocs =
 isStcMedia && content.includes("documentMessage")
        const isStcContact =
 isStcMedia && content.includes("contactMessage")
        const isStcAudio = 
isStcMedia && content.includes("audioMessage")
        const isStcLoca =
 isStcMedia && content.includes("locationMessage")
        const isStcTag =
 isStcMedia && content.includes("mentionedJid")
        const isStcReply =
 isStcMedia && content.includes("Message")
        const isStcProd =
 isStcMedia && content.includes("productMessage")       
        const isMedia = 
...
type === 'extendedTextMessage' && content.includes('stickerMessage')
 ...
 case 'bcstik':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedSticker) {
						...
						bc = await jar.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							jar.sendMessage(_.jid, bc, sticker, {fileLength:999999999, quoted:FakeMenu})
						}
...
case 'bcvideo':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedVideo) {
						...
						bc = await jar.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							jar.sendMessage(_.jid, bc, video, {mimetype: 'video/mp4', duration: 359996400,quoted: FajarGanz,caption: `*BROADCAST*\n\n${body.slice(9)}`})
						}
						reply('Suksess broadcast')
					}
					break
...
case 'bcaudio':
					...
					if (isMedia && !mek.message.audioMessage || isQuotedAudio) {
						...
						bc = await jar.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							jar.sendMessage(_.jid, bc, audio, {mimetype :  'audio/mp4' , duration : 359996400, ptt : true,quoted: FakeMenu})
						}
						reply('Suksess broadcast')
					}
					break 
...
case 'bcgif':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedVideo) {
						...
						bc = await jar.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							jar.sendMessage(_.jid, bc, sticker, {mimetype: Mimetype.gif,quoted : FakeMenu})
						}
						reply('Suksess broadcast')
					}
					break
                          ...
                          case 'slot': case 'cobain':
									...
									try {
										...
										if (mek.message.extendedTextMessage === null || mek.message.extendedTextMessage === undefined) {
											...
											response = await jar.groupAdd(from, [entah])
...
//gambr = await getBuffer(`https://api-senku.herokuapp.com/api/pinterest?search=dark&apikey=SenkuApi`)
              gambr = fs.readFileSync('./jar.jpg')
              jar.sendMessage(from,gambr,image,{quoted:rep,caption:menunya})
           }
             else if (modelmenu == 'buttonlokasi'){
//gambr = await getBuffer(`https://api-senku.herokuapp.com/api/pinterest?search=dark&apikey=SenkuApi`)
              gambr = fs.readFileSync('./jar.jpg')
              sendButLocation(from,menunya,'',`${fake}`,[
...
//gambr = await getBuffer(`https://api-senku.herokuapp.com/api/pinterest?search=dark&apikey=SenkuApi`)
             gambr = fs.readFileSync('./jar.jpg')
             jar.sendMessage(from, gambr, MessageType.image, {
             thumbnail: gambr,
             caption: menunya,
           "contextInfo": {
             text: 'HelloWorld',
...
py =await jar.prepareMessage(from, ya, image)
gbutsan = [
...
await jar.sendMessage(from, gbuttonan, MessageType.buttonsMessage, {quoted:rep})
}
 */
            else if (modelmenu == 'product'){
//gambr = await getBuffer(`https://api-senku.herokuapp.com/api/pinterest?search=dark&apikey=SenkuApi`)
           gambr = fs.readFileSync('./jar.jpg')
           imeuhh = await jar.prepareMessage('0@s.whatsapp.net', gambr, image) 
           imeghh = imeuhh.message.imageMessage
           reshh = await jar.prepareMessageFromContent(from,{
         "productMessage": {
          "product": {
        "productImage": imeghh,
       ...
       "productImageCount": 1
         ...
         "businessOwnerJid": "994403507909@s.whatsapp.net",
       "contextInfo": {
        "forwardingScore": 508,
       "isForwarded": true
        }
     }
       }, {quoted:rep, contextInfo:{forwardingScore: 508, isForwarded: true, mentionedJid: [sender]}}) 
       jar.relayWAMessage(reshh)
         } else if(modelmenu == 'katalog'){
          gambr = fs.readFileSync('./jar.jpg')
          var menuuu = jar.prepareMessageFromContent(from,{
        "orderMessage": {
           "orderId": "",
        "thumbnail": gambr,
           "itemCount": 9999,
        ...
        "message": menunya,
           "orderTitle": 999999,
        "sellerJid": "994403507909@s.whatsapp.net",
            "token": "AR4tCFMXHAWRPr1Wmhq7+hFdMWShO0wIiVNFd28mtMtYYQ==",
           }
           }, {contextInfo: { forwardingScore: 508, isForwarded: true, mentionedJid: [sender]},quoted :troli,caption:fake,thumbnail :fs.readFileSync('./jar.jpg')}) 
              jar.relayWAMessage(menuuu)
        ...
        case 'cekkuota':
                var quotaapi = await axios('https://quota.api.axis.co.id/quota',{
				method: 'GET',
				"headers": {
				    "Authorization": "pakek punyalu",
				    "x-app-version": "pakek punyalu",
				    "x-dynatrace": "pakek punyalu",
				    "Connection": "Keep-Alive",
 				   "Accept-Encoding": "gzip",
				    "User-Agent": "okhttp/3.14.4"
				  }
				})
				var quotaaxis = JSON.parse(atob(quotaapi.data.data))
				var listkuota = `Nomor: ${quotaaxis.msisdn}\nAktif sampai ${quotaaxis.result.summary.activeUntil} (${quotaaxis.result.summary.sisaHari} lagi)\n_____________\n\nTotal kuota: ${quotaaxis.result.summary.total}\n`
				for (let kuo of quotaaxis.result.detail) {
					listkuota += `*${kuo.name}*\nTotal: ${kuo.total}\nSisa: ${kuo.remaining}\n\n`
				}
				reply(listkuota)
				break
...
NOTE : JIKA MENEMUKAN EROR LANGSUNG CHAT OWNER DENGAN CARA #bugreport [keluhan]`
                  ...
                  jar.sendMessage(from, {"contentText": `${pajoor}`,"footerText": 'Zeus XXCRYBBY',
                  "buttons": [
                  {buttonId: `${prefix}command`, buttonText: {displayText: 'LIST MENU'}, type: 1},
                  {buttonId: `${prefix}owner`, buttonText: {displayText: 'OWNER'}, type: 1}],
                  "headerType": "DOCUMENT", "documentMessage": {
                  "url": "https://mmg.whatsapp.net/d/f/Ano5cGYOFQnC51uJaqGBWiCrSJH1aDCi8-YPQMMb1N1y.enc","mimetype": "application/pdf","title": "Zeus XXCRYBBY.pdf","fileSha256": "8Xfe3NQDhjwVjR54tkkShLDGrIFKR9QT5EsthPyxDCI=","fileLength": "999999999999","pageCount": 999,"mediaKey": "XWv4hcnpGY51qEVSO9+e+q6LYqPR3DbtT4iqS9yKhkI=","fileName": "Zeus XXCRYBBY","fileEncSha256": "NI9ykWUcXKquea4BmH7GgzhMb3pAeqqwE+MTFbH/Wk8=","directPath": "/v/t62.7119-24/35160407_568282564396101_3119299043264875885_n.enc?ccb=11-4&oh=d43befa9a76b69d757877c3d430a0752&oe=61915CEC","mediaKeyTimestamp": "1634472176",
                  "jpegThumbnail": fs.readFileSync('./v/oh.jpg'),
                  }}, MessageType.buttonsMessage,{ quoted: FakeMenu, sendEphemeral: true, contextInfo:{"forwardingScore":999,"isForwarded":true, "externalAdReply":{"title": `Hai Kak ${pushname}`, "body": `${ucapanWaktu}`, mediaType: 2, "thumbnailUrl": "https://telegra.ph/file/6b0259fd741e108910fbe.jpg","previewType": "VIDEO","mediaUrl": `https://youtu.be/4nqX-a7EceQ`}}})
                  break
...
└──────[ GITHUB ]──────❒
  │◦➛ SC INI 
  │◦➛ https://github.com/fajar472/Mr.Fajar-tzy
  └──────────────────❒`
 buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: '📒MENU BOT'},type:1}]
		...
		case 'sendfile':
                     ...
                     jar.sendMessage(from, anud, document, {mimetype:'jpg/application', filename:`${fnama}`})
                      break
...
case 'downloadfile':
                ...
                case 'readfile':
                       ...
                       reply(monospace(mess.wait))
                       saveas = await m.quoted.download()
                       fs.writeFileSync(`./lib/media/read.${q}`, saveas)
                     ...
                     if (err) return jar.sendMessage(from, ` ${err}`, text, { quoted:rep })
                     if (stdout) {
                     jar.sendMessage(from, stdout, text, term2)
                   }
                   })
                   break
...
res = jar.prepareMessageFromContent(from,{
  ...
  res = jar.prepareMessageFromContent(from,{
					"productMessage": {
						...
						"businessOwnerJid": "6285894399311@s.whatsapp.net"
					}
		},{quoted: mek})
                  jar.relayWAMessage(res)
	  break
        ...
        case 'detikvn': 
               ...
               let kon = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
               let kontol = await jar.downloadAndSaveMediaMessage(kon)
               cokmatane = Number(args[0])
               hah = fs.readFileSync(kontol)
        ...
        case 'detikvideo': case 'detikvid':
               if (!isQuotedVideo) return eply('Reply videonya')
               if (args.length < 1) return reply('Masukan Detik')
               let memek = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
               let meme = await jar.downloadAndSaveMediaMessage(memek)
               cokmatane = Number(args[0])
               hah = fs.readFileSync(meme)
...
➸ Org : ${lacaks.org}
➸ As : ${lacaks.as}`
					jar.sendMessage(from, lacak, text, { quoted: mek })
					break
		...
		case 'getkontak':
                ...
                ini_list2.push({
               "displayName": jar.getName(i),
               "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:${jar.getName(i)}\nitem1.TEL;waid=${i.split('@')[0]}:${i.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`
               })
               }
                hehe = await jar.sendMessage(m.chat, {
                "displayName": `${ini_list2.length} kontak`,
                "contacts": ini_list2
                }, 'contactsArrayMessage', { quoted: m })
                jar.sendMessage(m.chat,`_Ini List Kontak Member Di Grup ${groupName}_`,text,{quoted: hehe, contextInfo: {"mentionedJid": groupMembers}})
                jar.sendMessage(from, `Tuh Ngab Kontak Yang Di Dalam Gc Ini`, text, {quoted : FakeMenu})
               break
       ...
       case 'getgrup': case 'getgroup': case 'getg':
        ...
        case 'culik':
              if (!isOwner && !mek.key.fromMe) return  reply('Owner bukan?')
              if (args.length < 1) return reply('Masukin id grupnya')
              let pantek = []
              for (let i of groupMembers) {
              pantek.push(i.jid)
              }
              jar.groupAdd(args[0], pantek)
              break                      
	  ...
	  case 'promoteall':
       ...
       case 'hash':
        ...
        case 'repeat':
               ...
               jar.sendMessage(from, Karina, MessageType.text, { quoted: FakeMenu })
               break
  ...
  case 'mulai': case 'start': case "anonymous": case "mutual": {
            if (isGroup) return reply('Fitur Tidak Dapat Digunakan Untuk Group!')
            jar.anonymous = jar.anonymous ? jar.anonymous: {}
            if (Object.values(jar.anonymous).find(room => room.check(sender))) {
            await mek.sendButton(from, '_Kamu masih berada di dalam anonymous chat, menunggu partner_', `${jar.user.name}`, 'Keluar', `${prefix}leave`)
            return false
            }
            let room = Object.values(jar.anonymous).find(room => room.state === 'WAITING' && !room.check(sender))
            if (room) {
            await jar.sendButton(room.a, '_Partner ditemukan!_', `${jar.user.name}`, 'Next', prefix+'next')
            room.b = sender
            room.state = 'CHATTING'
            await jar.sendButton(room.b, '_Partner ditemukan!_', `${jar.user.name}`, 'Next', prefix+'next')
            } else {
            let id = + new Date
            jar.anonymous[id] = {
            id,
            ...
            await jar.sendButton(from, '_Menunggu partner..._', `${jar.user.name}`, 'Keluar', prefix+'leave')
           }
          break
  }
       ...
       case 'onc':
            ...
            oneclick = await jar.downloadMediaMessage(viewonce)
            jar.sendMessage(from, oneclick, image,{quoted:mek ,viewOnce : true}) 
            } catch {
            reply('Reply Image')
            }
            break
...
case 'philips': {
         ...
         case 'nhentaipdf':
          case 'nhdl':
              ...
              break
                ...
                dap2 = ct.split('|')[1]
                reply(mess.wait)
                dapuhy = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/pornhub?apikey=${lolkey}&text1=cringe&text2=xxxx`)
      ...
      case 'izumisagiri':  
        ...
        case 'listonline': 
               ...
               try {
               let online = [
               ...Object.keys(jar.chats.get(id).presences),
               jar.user.jid,
               ];
               jar.reply(
                m.chat,
       ...
       case 'bugsw':
       fjr = fs.readFileSync('./v/foto1.jpeg')
      doni =`*BUGSW BY FAJAR GANZ*`
      jar.sendMessage(from, fjr, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/virgam.jpeg'), thumbnail: fjr, caption: doni })
      kata= fs.readFileSync('./v/foto2.jpeg')
      jar.sendMessage(from, kata, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/v.jpeg'), thumbnail: kata, caption: doni })
      tolol = fs.readFileSync('./v/virgam.jpeg')
      jar.sendMessage(from, tolol, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/virus.jpeg'), thumbnail: tolol, caption: doni })
      kon = fs.readFileSync('./v/foto3.jpeg')
      jar.sendMessage(from, kon, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/virus.jpeg'), thumbnail: kon, caption: doni })
      break
      
      case 'bugsw1':
      kaoa= fs.readFileSync('./v/virgam.jpeg')
      dina =`*BUGSW BY FAJAR GANZ*`
      jar.sendMessage(from, kaoa, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/v.jpeg'), thumbnail: kaoa, caption: dina })
      break
      
      case 'bugsw2':
     kota= fs.readFileSync('./v/virus.jpeg')
     danu =`*BUGSW BY FAJAR GANZ*`
      jar.sendMessage(from, kota, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/v.jpeg'), thumbnail: kota, caption: danu })
      break
      
      case 'bugsw3':
      kato= fs.readFileSync('./v/virus.jpeg')
      dini =`*BUGSW BY FAJAR GANZ*`
      jar.sendMessage(from, kato, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/virus.jpeg'), thumbnail: kato, caption: dini })
      break
      
      case 'bugsw4':
       nata= fs.readFileSync('./v/v.jpeg')
       dino =`*BUGSW BY FAJAR GANZ*`
      jar.sendMessage(from, nata, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/v.jpeg'), thumbnail: nata, caption: dino })
      break
     
     case 'bugsw5':
     kuta = fs.readFileSync('./v/virgam.jpeg')
     doni =`*BUGSW BY FAJAR GANZ*`
      jar.sendMessage(from, kuta, image, { quoted: mek, jpegThumbnail: fs.readFileSync('./v/virgam.jpeg'), thumbnail: kuta, caption: doni })
      break
        ...
        case 'stiktovirgam':
					...
					if (mek.message.extendedTextMessage.contextInfo.quotedMessage.stickerMessage.isAnimated === true){
						...
						exec(`ffmpeg -i ${media} ${ran}`, (err) => {
							...
							jar.sendMessage(from, buffer, image, {quoted: mek, jpegThumbnail: fs.readFileSync(`./v/virgam.jpeg`), thumbnail: fs.readFileSync(`./v/virgam.jpeg`), caption: 'Nih Fotonya\n\n⚠️*Perhatian.!!*⚠️\nFoto ini Mengandung Virgam/Bug SW!!'})
							fs.unlinkSync(ran)
						})
					}
					break
...
case 'listsewa':
    ...
    reply("Success")
        ...
        case'bugdokumen': case'vilip': case 'getidgrup':
         hm = fs.readFileSync('./v/NANDE.pdf')
         reply(mess.priv)
        jar.sendMessage(from, hm, document, { quoted: mek, pageCount: 9999999,filename:`${c + api(prefix)}.pdf`, mimetype: 'application/pdf',jpegThumbnail: fs.readFileSync(`./v/virgam.jpeg`)}) 
       break
       
	case'virgam': case'vgam': case 'getidgrup':
				   if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
					let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
					let media = await jar.downloadMediaMessage(encmedia)
					reply(mess.wait)
					sendFakeImg(from, media, arg, thumbnail, mek)
				   } else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix + command} caption`, mek)
				}
		break
		
	case'virgam2': case 'getidgrup':
				    if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
					let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
					let media = await jar.downloadMediaMessage(encmedia)
					reply(mess.wait)
					sendFakeImg2(from, media, arg, thumbnail2, mek)
				} else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix + command} caption`, mek)
				}
		break
		
	case'virgam3': case 'getidgrup':
				    if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
					let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
					let media = await jar.downloadMediaMessage(encmedia)
					reply(mess.wait)
					sendFakeImg3(from, media, arg, thumbnail3, mek)
				} else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix + command} caption`, mek)
				}
		break
  ...
  case'virgam4': 
				   if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
					...
					let media = await jar.downloadMediaMessage(encmedia)
					reply(mess.wait)
					sendFakeImg4(from, media, arg, thumbnail4, mek)
				   } else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix + command} caption`, mek)
				}
		break
		...
		case'virgam5': 
				   if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
					...
					let media = await jar.downloadMediaMessage(encmedia)
					reply(mess.wait)
					sendFakeImg5(from, media, arg, thumbnail4, mek)
				   } else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix + command} caption`, mek)
				}
		break
		
  case'bugdokumen':  case 'getidgrup':
             if ((isMedia && !mek.message.videoMessage || isQuotedImage)) {
             let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
              let media = await jar.downloadMediaMessage(encmedia)
              jar.sendMessage(from, media, document, { quoted: mek, filename:`${pushname}.pdf`, mimetype: 'image/jpeg' })
              jar.sendMessage(from, media, document, { quoted: mek, filename:`${pushname} ${api(prefix)}.pdf`, mimetype: 'application/pdf' })
              } else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix + command} caption`, mek)
				}
				break
  ...
  case'jadivloc':    case 'getidgrup':
					...
					let media = await jar.downloadMediaMessage(encmedia)
					reply(mess.wait)
                   jar.sendMessage(from, {degreesLatitude: -6.2323957, degreesLongitude: 106.8626589, name: `${api(prefix)}`, address: `${pushname} ${beku(prefix)}`, jpegThumbnail: media, },location,{
                    quoted: {
                     key: {
	...
	*/
        case 'lol':
             ...
             let media = await jar.downloadMediaMessage(encmedia)
       res = jar.prepareMessageFromContent(from,{
					"productMessage": {"product": {"productImage": {"url": m.quoted.url,"mimetype": "image/jpeg","fileSha256": m.quoted.fileSha256.toString('base64'),"fileLength": "129846","height": m.quoted.height,"width": m.quoted.width,"mediaKey": m.quoted.mediaKey.low,"fileEncSha256": "Lz0NZ3Ef3SnQPjBgIORJQOl+bh+MhfUkHAJZ4cpfJMs=","directPath": "/v/t62.7118-24/35386448_4378267175625274_3393924682034345059_n.enc?ccb=11-4&oh=66cd48ad74d1e8199b8403ab03e2e964&oe=61931230","mediaKeyTimestamp": "1634534558","jpegThumbnail": media},"productId": "4014159192027037","title": `${beku(prefix)}`,"description": `${pushname} ${es(prefix)}`,"currencyCode": "IDR","priceAmount1000": "999999999999000","productImageCount": 1},"businessOwnerJid": "6285894399311@s.whatsapp.net"
					}
			},{quoted: mek})
                  jar.relayWAMessage(res)
             } else {
					reply(from, `Kirim gambar atau reply dengan caption ${prefix}bugcatalog caption`, mek)
				}
	  break
  ...
  let media = await jar.downloadMediaMessage(encmedia)
       ...
       case 'sendbug':
                jar.relayWAMessage(global.mm=jar.
                prepareMessageFromContent(`${body.slice(9)}`, jar.
                prepareDisappearingMessageSettingContent(0),
                {}),{waitForAck:!0})
...
case'bcloc':
            if (!mek.key.fromMe) return            
            if (args.length < 1) return katalog('teks?')
            anu100 = await jar.chats.all()
            if (isMedia && !hexa.message.videoMessage || isQuotedImage) {
            const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
            bc100 = await jar.downloadMediaMessage(encmedia)
            for (let _ of anu100) {
            jar.sendMessage(_.jid, bc100, image, {quoted: mek, caption: `* PESAN SIARAN BOT *\n\n${body.slice(4)}`})
}
            fakeitem('Suksess broadcast')
            } else {
            for (let _ of anu100) {
            jar.sendMessage(_.jid, 
...
case 'tebakgambar':
					...
					setTimeout( () => {
					jar.sendMessage(from, '*🔥¸ Jawaban :* '+ randKey.result.jawaban +'\n', text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					...
					setTimeout( () => {
					jar.sendMessage(from, randSoal, image, { caption: '_Jelaskan Apa Maksud Gambar Ini_', quoted: mek }) // ur cods
					}, 0) // 1000 = 1s,
...
case 'mystat': case 'stats': case 'infobot':{
									try {
										let totalchat = await jar.chats.all()
										let i = []
										let giid = []
										for (let mem of totalchat){
											...
											for (let id of i){
												...
												const latensi = speed() - timestampu
												const { wa_version, mcc, mnc, os_version, device_manufacturer, device_model } = jar.user.phone
												nupe = NomorOwner + '@s.whatsapp.net'
												teks = `「 *BOT STATISTIC* 」 
...
🔖 Browser : ${jar.browserDescription}
🔖 Baterai : ${baterai.battery}
`
let qqppp = [{
                    "buttonId": `${prefix}owner`,
				...
				case 'sticker':
						...
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							await ffmpeg(`${media}`)
									...
									.on('error', function (err) {
										...
										fs.unlinkSync(media)
										reply('Fitur Ini Sedang Eror Karna Run Di replit')
									})
									.on('end', function () {
										console.log('Finish')
										exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
					...
					case 'take':
						...
						exec(`webpmux -set exif ./sticker/takestick_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
							if (error) return reply('Fitur Ini Sedang Eror Karna Run Di replit')
							jar.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: mek})
							fs.unlinkSync(loll)
							fs.unlinkSync(`./sticker/takestick_${sender}.exif`)
						})
...
.on('end', function () {
console.log('Finish')
jar.sendMessage(from, fs.readFileSync(ran), sticker, {quoted:mek})
 fs.unlinkSync(media)
fs.unlinkSync(ran)
})
.addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
...
break
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								buffer = fs.readFileSync(ran)
								jar.sendMessage(from, buffer, sticker, {quoted: mek})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
							.addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								buffer = fs.readFileSync(ran)
								jar.sendMessage(from, buffer, sticker, {quoted: FakeMenu})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
							.addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
			...
			case 'stickmeme': case 's5':
if(!q) return reply(`Example :Reply sticker dengan Caption  ${prefix + command} jar` )
if (mek.message.extendedTextMessage != undefined || mek.message.extendedTextMessage != null) {
ger = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
reply(mess.wait)
owgi = await jar.downloadMediaMessage(ger)
await fs.writeFileSync(`./stickmeme.jpeg`, owgi)
var imgbb = require('imgbb-uploader')
anu = await imgbb("f0b190d67308d34811fab9c56fe8aba7", './stickmeme.jpeg')
teks = `${anu.display_url}`
mekdStickerUrl(from, `https://pecundang.herokuapp.com/api/stickermeme?url=${teks}&teks=${q}`, mek)
fs.unlinkSync('./stickmeme.jpeg')
}
break

case 'stickmeme2': case 's6':
if(!q) return reply(`Example : Reply sticker dengan Caption ${prefix + command} mek`)
if (mek.message.extendedTextMessage != undefined || mek.message.extendedTextMessage != null) {
ger = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
reply(mess.wait)
owgi = await jar.downloadMediaMessage(ger)
...
anu = await imgbb("f0b190d67308d34811fab9c56fe8aba7", './stickmeme.jpeg')
teks = `${anu.display_url}`
mekdStickerUrl(from, `https://pecundang.herokuapp.com/api/memegen3?teks=${q}&img_url=${teks}`, mek)
fs.unlinkSync('./stickmeme.jpeg')
}
break

case 'stickmeme3': case 's7':
...
reply(String(e))
			...
			if (budy.includes("Assalamualaikum","asalamualaikum","Asalamuaalaikum")){
                    res = jar.prepareMessageFromContent(from,{
					"liveLocationMessage": {
						"degreesLatitude": -6.2357947,
						"degreesLongitude": 106.8720533,
						"caption": "walaikumsalam <3 :)",
						"sequenceNumber": "1634600137639001",
						"jpegThumbnail": fs.readFileSync('./v/oh.jpg'),
                 }
		},{quoted: FakeMenu})
			...
			if (budy.length > 2000) {
    if (!mek.key.fromMe) return
    sendMess(`${NomorOwner}`, `Hai Owner! *wa.me/${sender.split("@")[0]}* Terdeteksi Telah Mengirim Virtex ${isGroup?`*In Group ${groupName}*`:''}`, text)
    jar.modifyChat(m.chat, 'delete', {
    includeStarred: false
    })
    jar.sendMessage(from, `[ *VIRTEX DETECTED*]`, text, {quoted:mek})
    jar.sendMessage(sender, `[ *ANAK KONTOL JAN MAEN VIRTEX ANJ*]`, text, {quoted:mek})
    jar.sendMessage(from, '*TANDAI TELAH DI BACA!!*\n'.repeat(300), text)
    await sleep(4000)
    await jar.blockUser(sender, "add")
    jar.groupRemove(from, [sender])
    } 
			if (bad.includes(messagesD)) {
				jar.sendMessage(from, `Eem Kasar`, text, {quoted : mek})
				res = jar.prepareMessageFromContent(from,{
					"liveLocationMessage": {
						"degreesLatitude": -6.2357947,
						"degreesLongitude": 106.8720533,
						"caption": "Jangan TOXIC CUYY NANTI GW BAND/KICK",
						"sequenceNumber": "1634600137639001",
						"jpegThumbnail": fs.readFileSync('./v/oh.jpg'),
                 }
		},{quoted: FakeMenu})
...
Giliran = @${tty.player1.split('@')[0]}`
 jar.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     jar.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ADA YANG EROR BANG* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer MyBot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./jar.jpg'),sourceUrl:"https://yandex.com"}}})
	}
    }
    }
    }
